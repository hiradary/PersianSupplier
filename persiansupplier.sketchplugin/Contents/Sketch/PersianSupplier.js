...
var PROVINCES = ["آذربایجان شرقی", "آذربایجان غربی", "اردبیل", "اصفهان", "البرز", "ایلام", "بوشهر", "تهران", "چهارمحال و بختیاری", "خراسان جنوبی", "خراسان رضوی", "خراسان شمالی", "خوزستان", "زنجان", "سمنان", "سیستان و بلوچستان", "فارس", "قزوین", "قم", "کردستان", "کرمان", "کرمانشاه", "کهگیلویه وبویراحمد", "گلستان", "گیلان", "لرستان", "مازندران", "مرکزی", "هرمزگان", "همدان", "یزد"];
...
/*!********************************!*\
  !*** ./src/PersianSupplier.js ***!
  \********************************/
/*! exports provided: onStartup, onShutdown, onSupplyCities, onSupplyProvinces, onSupplyCountries, onSupplyPhones, onSupplyId, onSupplyNames, onSupplyDates, onSupplyTime, onSupplyAddress, onSupplyJobs, onSupplyZipcodes, onSupplyEmail */
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "onSupplyProvinces", function() { return onSupplyProvinces; });
...
var PROVINCES = __webpack_require__(/*! ../constants/Provinces */ "./constants/Provinces.js");
...
function onSupplyProvinces(context) {
  var dataKey = context.data.key;
  var dataCount = context.data.requestedCount;
  var dataIndex = 0;

  while (dataIndex < dataCount) {
    var city = sample(PROVINCES);
    DataSupplier.supplyDataAtIndex(dataKey, city, dataIndex);
    dataIndex++;
  }
}
...
that['onSupplyProvinces'] = __skpm_run.bind(this, 'onSupplyProvinces');
